...
public class GetSepayTransactionsQuery : QueryBase<TransactionFilterCondition, TransactionOrderCondition>, IMapFrom<SepayTransactionDto>, IRequest<ApiSuccessResult<PagedResponse<SepayTransactionDto>>>
{
...
public sealed class TransactionOrderCondition : OrderCondition
{
