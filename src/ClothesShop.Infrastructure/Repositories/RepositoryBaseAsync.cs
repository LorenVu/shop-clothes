    ...
    where TContext : DbContext
{
    ...
    public IQueryable<TEntity> GetAllAsync(bool trackChanges = false, params Expression<Func<TEntity, object>>[] includeProperties)
    {
    ...
    public IQueryable<TEntity> FindByConditionAsync(Expression<Func<TEntity, bool>> predicate, bool trackChanges = false, params Expression<Func<TEntity, object>>[] includeProperties)
    {
    ...
    public Task<TEntity?> FindByIdAsync(TK id, params Expression<Func<TEntity, object>>[] includeProperties) =>
