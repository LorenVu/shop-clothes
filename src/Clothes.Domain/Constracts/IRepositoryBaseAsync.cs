    ...
    where TContext : DbContext
{
    ...
    IQueryable<TEntity> GetAllAsync(bool trackChanges = false, params Expression<Func<TEntity, TK>>[] includeProperties);
    ...
    Task<TEntity?> FindByIdAsync(TK id, params Expression<Func<TEntity, bool>>[] includeProperties);
}
